...
void DeviceManager::initialize_driver(  DeviceDriverType driver_type, 
    ...
    switch (driver_type) {
        ...
        case DeviceDriverType::SWITCH:
            ...
            break;
        case DeviceDriverType::SWITCH_PRO:
            device_driver_ = std::make_unique<SwitchProDevice>();
            break;
        case DeviceDriverType::CAPTURE:
            device_driver_ = std::make_unique<CaptureDevice>();
            break;
