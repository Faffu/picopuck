...
static const uint8_t STRING_MANUFACTURER[] = "Nintendo Co., Ltd.";
static const uint8_t STRING_PRODUCT[]      = "Pro Controller";
static const uint8_t STRING_VERSION[]      = "000000000001";
